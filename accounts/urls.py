...
urlpatterns = [
    ...
    path('fb/<int:id>/', views.fb, name='fb'),
    path('view_fb/<int:id>/', views.view_fb, name='view_fb'),
    ...
    path('register/normal_user/', views.register_normal_user,
    ...
    path('appartment_user_view/', views.appartment_user_view,
         name='appartment_user_view'),
    ...
    path('paymentpage/<str:name>/<str:price>',
         views.paymentpage, name='paymentpage'),
    ...
    path('admin_view_booking_appartment/', views.admin_view_booking_appartment,
         name='admin_view_booking_appartment'),
